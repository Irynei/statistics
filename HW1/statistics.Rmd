...
legend("topright", legend=c("Age > 50", "Age < 50"),col=c("darkolivegreen3", "tomato"), lwd=5)
```
...
normal <- rnorm(500000, 10, 9)
hist(normal, col="darkolivegreen3")
hist(simulated, col="tomato", add=T)

skewness(normal)
a = density(simulated)
plot(density(normal), col="darkolivegreen3")
# lines(a, col="tomato")
```
...
https://irynei.shinyapps.io/boxplot_animation/
https://irynei.shinyapps.io/hist_animation/

...
```
```{r}
s1 = salary[which(salary<2000)]
s2 = salary[which(salary>=2000 & salary < 4000)]
s3 = salary[which(salary>=4000)]
a1 = ceodata$age[which(ceodata$age < 50)]
a2 = ceodata$age[which(ceodata$age >= 50)]
```
